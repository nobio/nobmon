...
export class VeitsbronnWeatherMonitor {
  ...
  async monitor() {
    try {
      ...
      if (resp.data.main.temp) {
        ...
        data.push({
          name: 'veitsbronn-temperature', topic: 'temp', type: 'float', value: temp,
        });
      ...
      if (resp.data.wind.speed) {
        data.push({
          name: 'veitsbronn-windspeed', topic: 'windspeed', type: 'float', value: resp.data.wind.speed,
        });
      ...
      if (resp.data.wind.deg) {
        data.push({
          name: 'veitsbronn-winddir', topic: 'winddir', type: 'int', value: resp.data.wind.deg,
        });
      ...
      if (resp.data.main.humidity) {
        data.push({
          name: 'veitsbronn-humidity', topic: 'humidity', type: 'int', value: resp.data.main.humidity,
        });
      ...
      if (resp.data.main.pressure) {
        data.push({
          name: 'veitsbronn-pressure', topic: 'pressure', type: 'int', value: resp.data.main.pressure,
        });
      ...
      if (resp.data.clouds.all) {
        data.push({
          name: 'veitsbronn-clouds', topic: 'clouds', type: 'int', value: resp.data.clouds.all,
        });
      ...
      if (resp.data.rain && resp.data.rain['1h']) {
        data.push({
          name: 'veitsbronn-rain', topic: 'rain', type: 'float', value: resp.data.rain['1h'],
        });
