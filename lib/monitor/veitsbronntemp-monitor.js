...
class VeitsbronnTempMonitor {
  ...
  async monitor() {
    try {
      ...
      data = [{ name: 'veitsbronn-temperature', topic: 'temp', type: 'float', value: temp }];
      ...
      // wind speed................................................................
      data = [{ name: 'veitsbronn-windspeed', topic: 'windspeed', type: 'float', value: resp.data.wind.speed }];
      console.log(`${new Date().toLocaleString()} | monitoring Veitsbronn Wind Speed ${resp.data.wind.speed}m/s`);
      this.handlers.forEach(handler => { handler.send(data); });

      // humidity................................................................
      data = [{ name: 'veitsbronn-humidity', topic: 'humidity', type: 'int', value: resp.data.main.humidity }];
      console.log(`${new Date().toLocaleString()} | monitoring Veitsbronn Humidity ${resp.data.main.humidity}`);
      this.handlers.forEach(handler => { handler.send(data); });

      // pressure................................................................
      data = [{ name: 'veitsbronn-pressure', topic: 'pressure', type: 'int', value: resp.data.main.pressure }];
