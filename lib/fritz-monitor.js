  ...
  async monitor() {
    try {
      if (this.conFritz) {
        ...
        data.push({ name: 'upstream_current', topic: 'bndw', type: 'int', value: usage.upCurrent / 1024 / 1024 });
        data.push({ name: 'downstream_current', topic: 'bndw', type: 'int', value: usage.downCurrent / 1024 / 1024 });
        data.push({ name: 'upstream_mbit', topic: 'bndw', type: 'float', value: factUp });
        data.push({ name: 'downstream_mbit', topic: 'bndw', type: 'float', value: factDown });
