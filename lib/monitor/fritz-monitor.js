...
export class FritzboxMonitor {
  ...
  async monitor() {
    try {
      ...
      const data = [];
      data.push({
        name: 'upstreamRate', topic: 'bndw', type: 'float', value: usage.uploadRate,
      });
      data.push({
        name: 'downstreamRate', topic: 'bndw', type: 'float', value: usage.downloadRate,
      });
      data.push({
        name: 'upstreamTotal', topic: 'bndw', type: 'float', value: usage.uploadTotal,
      });
      data.push({
        name: 'downstreamTotal', topic: 'bndw', type: 'float', value: usage.downloadTotal,
      });
      data.push({
        name: 'upstreamMax', topic: 'bndw', type: 'float', value: usage.uploadMax,
      });
      data.push({
        name: 'downstreamMax', topic: 'bndw', type: 'float', value: usage.downloadMax,
      });
